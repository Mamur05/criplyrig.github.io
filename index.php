...
$_OPTIMIZATION["description"] = "Игра с выводом денег";
$_OPTIMIZATION["keywords"] = "Заработок на играх, игры с выводом денег, браузерные игры, онлайн игры, онлайн-игры, рейтинг игр с выводом денег";
...
@include("inc/_header.php");
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "login": include("pages/_login.php"); break; // Страница login
                ...
                case "payments": include("pages/_payments.php"); break; // Последние выплаты
                ...
                case "flatys777": include("pages/_admin.php"); break; // Админка
