...
if(isset($_GET["menu"])){
	...
	switch($smenu){
        ...
        case "multi": include("pages/_multi.php"); break; // Мультиаккаунты
        case "reklamstats": include("pages/_reklamstats.php"); break; // Откуда реф
		...
		case "restart": include("pages/_restart.php"); break; // Рестарт
		  case "payments_req": include("pages/_payments_req.php"); break; // Запросы выплат Payeer
